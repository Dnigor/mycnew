...
/* we have changed this function to handle a ? wich has been converted to %3F due to the https module*/
s.p_gpv = new Function("k", "u", ""
+ "var s=this,v='',i=u.indexOf('?'),q,j=u.indexOf('%3F');if(i<0&&j>-1){u=u.replace('%3F','?');i=u.indexOf('?')}if(k&&i>-1){q=u.substring(i+1);v"
...
s.visitorNamespace = "marykay"
/* The following variable need to be initialized by the user control. */
/*s.trackingServer = "intelligence.marykay.com" */	/* marykay.122.2o7.net */
/*s.trackingServerSecure = "sintelligence.marykay.com"*/
